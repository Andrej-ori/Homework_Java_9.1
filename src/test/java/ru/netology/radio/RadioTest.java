...
public class RadioTest {
    ...
    @Test
    public void shouldSetRadioDefault() { // проверка значения в пределах диапазона (при количестве радиостанций по умолчанию)
    ...
    @Test
    public void souidNotSetMaxRadioDefault() { // проверка значения больше диапазона (при количестве радиостанций по умолчанию)
